...
public class shipmovementfight : MonoBehaviour
{
		...
		void Start ()
		{
				if (SpaceShip.ship_name == "SciFi_Fighter_AK5") {
						controler = (GameObject)Instantiate (controler1, new Vector3 (0, 0, 3), transform.rotation);
						controler.transform.eulerAngles = new Vector3 (0, 0, 0);

				} else if (SpaceShip.ship_name == "vehicle_enemyShip") {
						controler = (GameObject)Instantiate (controler2, new Vector3 (0, 0, 3), transform.rotation);
						controler.transform.eulerAngles = new Vector3 (0, 0, 0);
				}
		}
		...
		void Update ()
		{
				if (Input.GetKey (KeyCode.Mouse0)) {
						...
						if ((pos.y < 200) && (controler.transform.position.x + Time.deltaTime * 15) < 4.5f) {
						...
						else if ((pos.y > 200) && (controler.transform.position.x - Time.deltaTime * 15) > -5.3f) {
								controler.transform.Translate (-(Time.deltaTime * 15), 0, 0);
								shootspawn.Translate (-Time.deltaTime * 15, 0, 0);
								shootspawn2.Translate (-Time.deltaTime * 15, 0, 0);
								shootspawn3.Translate (-Time.deltaTime * 15, 0, 0);
						...
						else if (Input.GetKey ("up") && (controler.transform.position.x - Time.deltaTime * 15) > -5.3f) {
								controler.transform.Translate (-(Time.deltaTime * 15), 0, 0);
								shootspawn.Translate (-Time.deltaTime * 15, 0, 0);
								shootspawn2.Translate (-Time.deltaTime * 15, 0, 0);
								shootspawn3.Translate (-Time.deltaTime * 15, 0, 0);
